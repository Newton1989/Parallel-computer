  ...
  unsigned char *iv, unsigned char *ciphertext)
{
  ...
  unsigned char *plaintext =  (unsigned char *)"What makes you who you are is the continues desire for success";
  ...
  int i,j,k,l,m;
  #pragma omp parallel private (i,j,k,l,m)
  ...
  char pbuffer[1024];
  char password[17]="################";
  char alphabet[] = "naweotaaaaaaaaaa";
    ...
    for(int i = 0; i < 16; i++)
  {
    password[0] = alphabet [i];
       ...
       if (strncmp(ciphertext,ciphertext2, 16) == 0){
        ...
        //  printf("Thread Numbers %d: %d%d%d%d%d\n", omp_get_thread_num(), i,j,k,l,m);
          printf("  Precessor core: %d\n", omp_get_num_threads());
          int ticks = clock();
